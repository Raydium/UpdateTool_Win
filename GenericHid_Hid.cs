...
{    
    ...
    {         
		...
		internal Boolean GetInputReportViaControlTransfer(SafeFileHandle hidHandle, ref Byte[] inputReportBuffer, int length)
		{
			Boolean success;
			...
			try
			{
                ...
                success = HidD_GetInputReport(hidHandle, inputReportBuffer, length);
		...
		internal Boolean SendFeatureReport(SafeFileHandle hidHandle, Byte[] outFeatureReportBuffer, int length)
		{
			Boolean success = false;
			...
			try
			{
                ...
                success = HidD_SetFeature(hidHandle, outFeatureReportBuffer, length);
            ...
            internal Boolean SendOutputReportViaControlTransfer(SafeFileHandle hidHandle, Byte[] outputReportBuffer, int length) 
            {                 
                Boolean success = false; 
                ...
                { 
                    ...
                    success = HidD_SetOutputReport(hidHandle, outputReportBuffer, length); 
